/**
 * Chess.com Style SVG Icons
 */

const ChessIcons = {
  knight: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 22H5v-2h14v2M13 2c-1.25 0-2.42.62-3.11 1.66L7 8l2 2 2.06-2.75.94.75-2.38 3.88C9.25 12.56 9 13.26 9 14v6h6v-6c0-.74-.25-1.44-.62-2.12L12 8l.94-.75L15 10l2-2-2.89-4.34C13.42 2.62 12.25 2 11 2h2z"/></svg>`,

  analysis: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 14h4v7H3v-7zM10 10h4v11h-4V10zM17 3h4v18h-4V3z"/></svg>`,
  ...
  target: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/><circle cx="12" cy="12" r="5"/></svg>`,
